...
import com.example.data.RequestStatus.Error
import com.example.data.RequestStatus.InProgress
import com.example.data.RequestStatus.Success
...
internal class DefaultRequestResponseMergeStrategy<T : Any> : MergeStrategy<RequestStatus<T>> {
    ...
    private fun merge(cache: RequestStatus.Success<T>, network: RequestStatus.InProgress<T>): RequestStatus<T> {
